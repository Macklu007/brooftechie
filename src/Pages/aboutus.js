     ...
     <div className={` relative`}>
       ...
       <div>
        ...
        <div className='flex flex-col gap-5 relative bg-richblack-800 w-12/12 mx-auto items-center pt-10  h-[430px] '>
         ...
         <h1 className=' text-2xl md:text-4xl text-white font-bold w-[55%] text-center'>
          Driving Innovation in Online Education for a <Highlighted text= " Brighter Future"/> 
         </h1>
         <p className='text-richblack-300 w-[55%] font-bold text-center mb-20 md:text-base text-xs '> Brooftechie is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>

           
           <div className=' flex flex-row gap-5 absolute -bottom-10 md:-bottom-40 mx-auto w-[95%] md:w-11/12 justify-around '>
            ...
            <img src={photo3} alt='pic' className=' w-[28%] h-[30%] rounded-3xl'  />
             ...
             <div className=' w-11/12 mx-auto justify-center  flex items-end h-[350px] '>
              ...
              <h1 className='text-[24px] md:text-4xl text-center text-richblack-300 w-[85%]'>" We are passionate about revolutionizing the way we learn. Our innovative platform <span className='text-cyan-400'>combines technology</span>, <span className='text-orange-500'>expertise</span> , and community to create an <span className='text-orange-400'>unparalleled educational experience</span> "</h1>
        ...
        <div className=' w-11/12 flex flex-col mt-40 mx-auto gap-24 mb-20 ' >
          ...
          <div className='flex flex-col md:flex-row justify-around w-[100%] items-center  '>
          ...
          <div className='flex flex-col md:flex-row gap-5  md:gap-0  md:flex-rows justify-around w-[100%] items-center '>
            ...
            <div className='flex flex-col gap-2 md:w-[40%] w-[90%] ' >
             ...
             <p className='text-richblack-300  font-inter text-[16px] md:text-base  text-justify'>With this vision in mind, we set out on a journey to create an e-learning platform that would revolutionize the way people learn. Our team of dedicated experts worked tirelessly to develop a robust and intuitive platform that combines cutting-edge technology with engaging content, fostering a dynamic and interactive learning experience..</p>
             ...
             <p className='text-richblack-300  font-inter md:text-base text-[16px]  text-justify'>our mission goes beyond just delivering courses online. We wanted to create a vibrant community of learners, where individuals can connect, collaborate, and learn from one another. We believe that knowledge thrives in an environment of sharing and dialogue, and we foster this spirit of collaboration through forums, live sessions, and networking opportunities.</p>
        ...
        <div>
          ...
          <div className='flex flex-col  ' >
            ...
            <div className='h-[300px] md:h-screen  flex flex-col w-6/12 mx-auto '>
