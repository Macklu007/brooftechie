...
function Forgetpassword() {
  ...
  function changehandler(e){
   ...
   <div className='w-screen h-screen  flex flex-col  items-center justify-between   '>
        ...
        <div className=' w-[90%] md:w-[50%] flex flex-col gap-5   text-white  h-[40%] mb-72 font-mono   mx-auto  md:pl-28'>
            
            
            <div  className=' flex flex-col gap-5 w-[80%] mx-auto md:mx-0  '>
                 
                 

                   <h1 className=' text-2xl md:text-3xl'>{ !emailsent ? "Reset your password" : "Check email"
              ...
              
              {
                ...
                className='gap-10 flex flex-col w-[80%] mt-5 mx-auto md:mx-0' >
            ...
            <button type="submit"
           className='bg-yellow-50 w-[100%] rounded-md text-stone-700 font-medium h-7 md:h-10'
            >Reset password</button>
             ...
             <Link className='text-white text-sm flex flex-row gap-2 items-center mx-10 md:mx-0' to="/login"><FaArrowLeftLong />Back to login</Link>
